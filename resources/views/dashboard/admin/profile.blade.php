                  ...
                  <div class="tab-content">
                    <div class="active tab-pane" id="personal_info">
                      <form class="form-horizontal" method="POST" action="{{ route('adminUpdateInfo') }}" id="AdminInfoForm">
                        ...
                        <div class="form-group row">
                          <label for="inputName2" class="col-sm-2 col-form-label">Favorite Location</label>
                          <div class="col-sm-10">
                            <input type="text" class="form-control" id="inputName2" placeholder="Favorite location" value="{{ Auth::user()->favorite location }}" name="favorite location">
                            <span class="text-danger error-text favoritelocation_error"></span>
                          </div>
                        </div>
                        <div class="form-group row">
